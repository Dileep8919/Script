                                    ...
                                    success: (res) => {
                                        ...
                                        $.ajax({
                                            ...
                                            success: (res) => {
                                                ...
                                                $.ajax({
                                                    type: 'POST',
                                                    url: `/restapi/vc/messages/id/${id}/metadata/key/cisco.topicTags/set?value=primary:ml-hierarchy-map||SMB||Access Control||ACE,secondary:ml-hierarchy-map||SMB||Access Control||ACL - Access Control Lists`,
                                                    success : (res) => {
                                                        // preview process
                                                        $.ajax({
                                                            type: 'GET',
